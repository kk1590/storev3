...
public class TbGoodsDescController {
    ...
    public TbGoodsDesc selectOne(Long id) {
        return this.tbGoodsDescService.selectByPrimaryKey(id);
    }
    ...
    public PageModel<TbGoodsDesc> getTbGoodsDescByPage(int page,int size){
        return tbGoodsDescService.queryAllByLimit(page,size);
    }
    ...
    public Result deleteByIds(Long[] ids){
        try {
            tbGoodsDescService.deleteByPrimaryKeys(ids);
    ...
    public PageModel<TbGoodsDesc> getTbGoodsDescByPage(@RequestBody TbGoodsDesc tbGoodsDesc,int page,int size){
        return tbGoodsDescService.queryAllByLimit(tbGoodsDesc,page,size);
    }
