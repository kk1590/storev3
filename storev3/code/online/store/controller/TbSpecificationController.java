...
public class TbSpecificationController {
    ...
    public PageModel<TbSpecification> getTbSpecificationByPage(int page,int size){
        return tbSpecificationService.queryAllByLimit(page,size);
    }
    ...
    public Result add(@RequestBody TbSpecification tbSpecification){
        try {
            tbSpecificationService.insert(tbSpecification);
    ...
    public PageModel<TbSpecification> getTbSpecificationByPage(@RequestBody TbSpecification tbSpecification,int page,int size){
        return tbSpecificationService.queryAllByLimit(tbSpecification,page,size);
    }
