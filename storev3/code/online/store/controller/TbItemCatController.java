...
public class TbItemCatController {
    ...
    public PageModel<TbItemCat> getTbItemCatByPage(int page,int size){
        return tbItemCatService.queryAllByLimit(page,size);
    }
    ...
    public PageModel<TbItemCat> getTbItemCatByPage(@RequestBody TbItemCat tbItemCat,int page,int size){
        return tbItemCatService.queryAllByLimit(tbItemCat,page,size);
    }
