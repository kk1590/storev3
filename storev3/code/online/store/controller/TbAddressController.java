...
public class TbAddressController {
    ...
    public TbAddress selectOne(Long id) {
        return this.tbAddressService.selectByPrimaryKey(id);
    }
    ...
    public List<TbAddress> findAll(){
        return tbAddressService.queryAllByLimit();
    }
    ...
    public PageModel<TbAddress> getTbAddressByPage(int page,int size){
        return tbAddressService.queryAllByLimit(page,size);
    }
    ...
    public Result add(@RequestBody TbAddress tbAddress){
        try {
            tbAddressService.insert(tbAddress);
    ...
    public Result deleteByIds(Long[] ids){
        try {
            tbAddressService.deleteByPrimaryKeys(ids);
     ...
     * 分页查询按条件查询数据
     *
     * @param tbAddress 实例对象(封装了查询的关键字)
     * @return 列表数据
     */
    @RequestMapping("search")
    public PageModel<TbAddress> getTbAddressByPage(@RequestBody TbAddress tbAddress,int page,int size){
        return tbAddressService.queryAllByLimit(tbAddress,page,size);
    }
