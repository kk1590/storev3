...
public interface TbSeckillGoodsService {
     ...
     * @return 对象列表
     */
    PageModel<TbSeckillGoods> queryAllByLimit(int offset, int limit);
     ...
     * @return 对象列表
     */
    List<TbSeckillGoods> queryAllByLimit();
     ...
     * @return pageModel
     */
    PageModel<TbSeckillGoods> queryAllByLimit(TbSeckillGoods tbSeckillGoods,int offset, int limit);
