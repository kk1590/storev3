/*TbSpecificationOptionService 服务层js offset, int limit*/
app.service("tbSpecificationOptionService",function ($http) {
    ...
    this.findPage=function (page,size) {
        return $http.get('../tbSpecificationOption/findPage.do?offset='+page+'&limit='+size);
    };
    ...
    this.search=function (page,size,searchEntity) {
        return $http.post('../tbSpecificationOption/search.do?offset='+page +'&limit='+size,searchEntity);
    };
});