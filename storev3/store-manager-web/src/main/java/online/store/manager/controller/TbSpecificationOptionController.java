...
import online.store.sellergoods.service.TbSpecificationOptionService;
...
public class TbSpecificationOptionController {
    ...
    public PageModel<TbSpecificationOption> getTbSpecificationOptionByPage(int offset, int limit){
        return tbSpecificationOptionService.queryAllByLimit(offset,limit);
    }
    ...
    public PageModel<TbSpecificationOption> getTbSpecificationOptionByPage(@RequestBody TbSpecificationOption tbSpecificationOption,int offset, int limit){
        return tbSpecificationOptionService.queryAllByLimit(tbSpecificationOption,offset,limit);
    }
